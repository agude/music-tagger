...
These are the allowed genre values for `music-tagger genre`. Reject any
value not on this list.
...
| Modern Rock | Post-2000 alt/indie rock |
...
| Soft Rock | Mellow, acoustic-leaning rock |
